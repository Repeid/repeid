...
public class DBLockTest extends AbstractModelTest {
    ...
    public void testLockConcurrently() throws Exception {
        ...
        final RepeidSessionFactory sessionFactory = organizationManager.getSession().getRepeidSessionFactory();
    ...
    private void lock(RepeidSession session, Semaphore semaphore) {
