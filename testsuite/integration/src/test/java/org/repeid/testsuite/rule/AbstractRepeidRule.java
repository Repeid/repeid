...
public abstract class AbstractRepeidRule extends ExternalResource {
	...
	public void addErrorPage(String errorPage, DeploymentInfo di) {
		...
		di.addErrorPage(new ErrorPage(errorPage, 400)).addErrorPage(new ErrorPage(errorPage, 401))
				.addErrorPage(new ErrorPage(errorPage, 403)).addErrorPage(new ErrorPage(errorPage, 500));
	}

	public void deployJaxrsApplication(String name, String contextPath, Class<? extends Application> applicationClass,
	...
	public class DeploymentBuilder {
		...
		public DeploymentBuilder keycloakConfigResolver(
				Class<? extends KeycloakConfigResolver> keycloakConfigResolver) {
