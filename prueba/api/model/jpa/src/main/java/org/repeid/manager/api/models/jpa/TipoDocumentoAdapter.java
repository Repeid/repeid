 ...
 */
public class TipoDocumentoAdapter implements TipoDocumentoModel, JpaModel<TipoDocumentoEntity> {
	...
	public TipoDocumentoAdapter(KeycloakSession session, EntityManager em, TipoDocumentoEntity tipoDocumento) {
