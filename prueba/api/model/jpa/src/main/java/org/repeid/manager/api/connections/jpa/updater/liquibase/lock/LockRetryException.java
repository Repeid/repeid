...
/**
 * Indicates that retrieve lock wasn't successful, but it worth to retry it in
 * different transaction (For example if we were trying to create LOCK table,
 * but other transaction created the table in the meantime etc)
 *
