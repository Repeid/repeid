 ...
 */
public class PersonaNaturalAlreadyExistsException extends AbstractAlreadyExistsException {
     ...
     * Constructor.
     */
    public PersonaNaturalAlreadyExistsException() {
    }
     ...
     */
    public PersonaNaturalAlreadyExistsException(String message) {
        super(message);
    }
    ...
    public int getErrorCode() {
        return ErrorCodes.PERSONA_NATURAL_ALREADY_EXISTS;
    }
    ...
    public String getMoreInfoUrl() {
        return ErrorCodes.PERSONA_NATURAL_ALREADY_EXISTS_INFO;
    }
