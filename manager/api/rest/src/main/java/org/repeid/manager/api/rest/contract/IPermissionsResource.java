...
public interface IPermissionsResource {
     ...
     *             when a request is sent for a user who does not exist
     * @throws NotAuthorizedException
     *             when the user is not authorized to perform this action
     */
    @GET
    @Path("{userId}")
    @Produces(MediaType.APPLICATION_JSON)
    public UserPermissionsRepresentation getPermissionsForUser(@PathParam("userId") String userId)
