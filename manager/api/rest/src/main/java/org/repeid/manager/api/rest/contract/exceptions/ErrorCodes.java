...
/**
 * A set of error codes used by the application when returning errors via the DT
 * REST API.
 *
...
public final class ErrorCodes {
	...
	//
	// PersonaNatural API related
	//
	public static final int PERSONA_NATURAL_NOT_FOUND = 2001;
	public static final int PERSONA_NATURAL_ALREADY_EXISTS = 2002;
	public static final int PERSONA_NATURAL_LOCKED = 2003;

	public static final String PERSONA_NATURAL_NOT_FOUND_INFO = null;
	public static final String PERSONA_NATURAL_ALREADY_EXISTS_INFO = null;
	public static final String PERSONA_NATURAL_LOCKED_INFO = null;

	//
	// PersonaJuridica API related
	//
	public static final int PERSONA_JURIDICA_NOT_FOUND = 2001;
	public static final int PERSONA_JURIDICA_ALREADY_EXISTS = 2002;
	public static final int PERSONA_JURIDICA_LOCKED = 2003;

	public static final String PERSONA_JURIDICA_NOT_FOUND_INFO = null;
	public static final String PERSONA_JURIDICA_ALREADY_EXISTS_INFO = null;
	public static final String PERSONA_JURIDICA_LOCKED_INFO = null;
