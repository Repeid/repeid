 ...
 */
@ApplicationScoped
@SecurityContextFactory(SecurityContextType.KEYCLOAK)
public class KeycloakSecurityContext extends AbstractSecurityContext {
	...
	/**
	 * @see org.repeid.manager.api.security.impl.DefaultSecurityContext#getFullName()
	 */
	@Override
	...
	/**
	 * @see org.repeid.manager.api.security.impl.DefaultSecurityContext#getEmail()
	 */
	@Override
