...
public interface Theme {
	...
	public enum Type {
		LOGIN, ACCOUNT, ADMIN, EMAIL, WELCOME, COMMON
	};
	...
	/**
	 * Same as getMessages(baseBundlename, locale), but uses a default
	 * baseBundlename such as "messages".
	 *
	 * @param locale
	 *            The locale of the desired message bundle.
