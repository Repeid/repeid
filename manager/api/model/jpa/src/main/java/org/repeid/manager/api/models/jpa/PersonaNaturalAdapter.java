 ...
 */
public class PersonaNaturalAdapter implements PersonaNaturalModel, JpaModel<PersonaNaturalEntity> {

	private PersonaNaturalEntity personaNatural;
	private EntityManager em;
	private final KeycloakSession session;

	public PersonaNaturalAdapter(KeycloakSession session, EntityManager em, PersonaNaturalEntity personaNatural) {
	...
	@Override
	public PersonaNaturalEntity getEntity() {
