...
public class JpaUserProvider extends AbstractJpaStorage implements UserProvider {
	 ...
	 * firstResult, int maxResults) { TypedQuery<TipoDocumentoEntity> query = em
	...
	public SearchResultsModel<UserModel> search(SearchCriteriaModel criteria, String filterText) {
		SearchResultsModel<UserEntity> entityResult = findFullText(criteria, UserEntity.class, filterText, "username");
