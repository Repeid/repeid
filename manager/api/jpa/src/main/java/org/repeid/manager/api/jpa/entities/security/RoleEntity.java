 ...
 *******************************************************************************/
package org.repeid.manager.api.jpa.entities.security;
 ...
 * permissions granted to users who are members of organizations via the role.
 *
...
public class RoleEntity implements Serializable {
	...
	public String toString() {
		return "RoleEntity [id=" + id + ", name=" + name + ", description=" + description + ", createdBy=" + createdBy
				+ ", createdOn=" + createdOn + ", autoGrant=" + autoGrant + ", permissions=" + permissions + "]";
	}
