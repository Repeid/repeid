 ...
 */
@Listener
public class NaturalPersonCacheManager extends CacheManager {

	protected static final Logger logger = Logger.getLogger(NaturalPersonCacheManager.class);

	public NaturalPersonCacheManager(Cache<String, Revisioned> cache, Cache<String, Long> revisions) {
