 ...
 */
@Listener
public class LegalPersonCacheManager extends CacheManager {

	protected static final Logger logger = Logger.getLogger(LegalPersonCacheManager.class);

	public LegalPersonCacheManager(Cache<String, Revisioned> cache, Cache<String, Long> revisions) {
