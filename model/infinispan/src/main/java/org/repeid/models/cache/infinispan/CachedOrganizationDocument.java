 ...
 * @version $Revision: 1 $
 */
public class CachedOrganizationDocument extends CachedDocument {

	public CachedOrganizationDocument(Long revision, DocumentModel model, OrganizationModel realm) {
