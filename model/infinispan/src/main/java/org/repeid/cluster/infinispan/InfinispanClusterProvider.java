...
public class InfinispanClusterProvider implements ClusterProvider {
    ...
    public InfinispanClusterProvider(InfinispanClusterProviderFactory factory, RepeidSession session, Cache<String, Serializable> cache) {
    ...
    public int getClusterStartupTime() {
        ...
        if (existingClusterStartTime != null) {
            ...
            int serverStartTime = (int) (session.getRepeidSessionFactory().getServerStartupTimestamp() / 1000);
