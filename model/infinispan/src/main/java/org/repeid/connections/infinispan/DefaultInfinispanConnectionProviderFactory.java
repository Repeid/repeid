...
public class DefaultInfinispanConnectionProviderFactory implements InfinispanConnectionProviderFactory {
    ...
    @Override
    public InfinispanConnectionProvider create(RepeidSession session) {
        lazyInit();
    ...
    protected void initEmbedded() {
        ...
        cacheManager.defineConfiguration(InfinispanConnectionProvider.NATURALPERSON_CACHE_NAME, invalidationCacheConfiguration);
        cacheManager.defineConfiguration(InfinispanConnectionProvider.LEGALPERSON_CACHE_NAME, invalidationCacheConfiguration);
